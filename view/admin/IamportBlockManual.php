    ...
    <div class="iamport-block-box">
      ...
      <div class="iamport-block-left">
        ...
        <ul>
          ...
          <li>-<code>구매자 이름</code>: 구매자 이름(입력된 값은 기본 필드에 자동으로 반영됨)</li>
          <li>-<code>구매자 이메일</code>: 구매자 이메일(입력된 값은 기본 필드에 자동으로 반영됨)</li>
          <li>-<code>구매자 전화번호</code>: 구매자 전화번호(입력된 값은 기본 필드에 자동으로 반영됨)</li>
          <li>-<code>구매자 주소</code>: 구매자 주소(입력된 값은 기본 필드에 자동으로 반영됨)</li>
        </ul>
        <p>
